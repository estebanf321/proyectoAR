...
$subject='Reclamos y/o Quejas desde la web';
...
<body>
    ...
    <main class="holder">
        <h2>QUEJA ENVIADA</h2>
        <p>¡GRACIAS POR HABER REALIZADO SU RECLAMO !...</p>
        <p > a la brevedad estaremos poniendonos en contacto con usted
              para dar una respuesta al mismo, el mismo nos ayuda a mejorar</p>
    ...
    <footer>
        ...
        <div class="holder">
            <h5> Todas las marcas y logos están presentes s&oacutelo a título informativo y son propiedad de sus respectivos
                dueños.</h5>
            <p> Autopartes Rosario&copy;2021 - Todos los derechos reservados.</p>
            <h5>Av. Eva Per&oacuten Nº 7201 - Rosario - Santa Fe - Argentina // WhatsApp: +3413507313 -
